...
void CreateGUI() {
   // Zmieniamy X na np. 180, aby przyciski nie dotykały samej krawędzi osi ceny
   ...
   // Dodaj to na końcu CreateGUI()
    CreateButton("BTN_PANIC", 180, 110, "CLOSE ALL", false); 
    ObjectSetInteger(0, "BTN_PANIC", OBJPROP_BGCOLOR, clrRed); // Wymuszamy czerwony kolor

   

    // --- TUTAJ DODAJESZ PRZYCISK PANIC ---
   CreateButton("BTN_PANIC", 180, 110, "CLOSE ALL", false); 
   // Nadpisujemy kolor na czerwony, żeby od razu było widać, że to "bezpiecznik"
